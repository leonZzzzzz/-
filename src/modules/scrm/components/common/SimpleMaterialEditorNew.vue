      ...
      <div class="edit-content" :style="`height: ${materialType === 'text' ? 155 : 190}px`">
        <template v-if="materialType === 'text'">
          <div style="box-sizing: border-box" class="text_image">
            ...
            <el-button-group v-if="fromMaterial" style="position:absolute;right:0px;top:5px">
            ...
            <div class="btn-group" v-if="fromMaterial">
              <el-button-group style="text-align:right">
                ...
                <div style="margin-top:5px">
                  <el-button type="primary" size="small" icon="el-icon-folder-opened"></el-button>
                  <el-button type="primary" size="small" style="margin:0" @click="showRadarSelectionDialog"
                    >从雷达中选择</el-button
                  >
                </div>
              </el-button-group>
...
export default {
  ...
  data() {
    ...
    return {
      inputId: Math.random()
        .toString(36)
        .substr(2), // 文本输入id设为随机字符串，以免在编辑或者添加文本时插入文本的id相同
