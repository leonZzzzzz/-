  ...
  <div class="management">
    <div class="m-top">
      <div class="m-top-left">
        <span>店铺成员 </span>
        <span>成员可以通过“企成互动”公众号实时收到店铺状态通知（包括：活动报名提醒/新订单提醒/捐赠成功通知等）</span>
      </div>
      ...
      <div class="member-list">
        <div class="list-item" v-for="(item, index) in managerList" :key="index">
          <div class="item-right">
            <div class="right-img">
              <el-avatar :size="60" shape="square" :src="item.headImage" @error="errorHandler">
          ...
          <div class="item-left" @click="deleteManager(item.id, item.appellation)">删除</div>
        </div>
      </div>
    </div>
    ...
    >
      <div class="dialog-content">
        <qrcode :value="qrCodeForm.href" tag="img" :options="{ size: 150 }"></qrcode>
