        ...
        <div class="cont-left">
          <div class="member-msg-div">
            <div class="member-msg" @click.stop="chooseDispose()">
              <img class="member-avatar" :src="customerNameListFirst.thumbAvatar" alt="" />
              <div class="member-name">{{ customerNameListFirst.name }}</div>
            ...
            <transition name="el-zoom-in-top">
              <div class="member-msg-block" v-if="chooseDiv == true">
                <!-- <div class="customer-all-none" v-if="customerAllList.length == 0">暂无成员数据</div> -->

                <div class="member-search">
                  <div>
                    <span class="all-text">全部成员({{ customerAllList.length || 0 }})</span>
                    <el-input
          ...
          <div class="message-total">
            ...
            <span>共有 {{ ByUserPage.total }} 个会话</span>
            <el-input
              placeholder="请输入成员名称"
            ...
            <div v-if="customerList.length != 0">
              ...
              >
                <div class="item-right">
                  <img class="customer-avatar" :src="item.cover | isHttp" alt="" />
                  <div class="customer-msg">
                    <div class="msg-info">
                      <div class="msg-name">{{ item.name || '未知' }}</div>
                      <div class="msg-tag">
                        {{
