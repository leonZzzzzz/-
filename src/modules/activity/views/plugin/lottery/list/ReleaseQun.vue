    ...
    <div class="context-box" :style="{ height: `${areaHeight}px` }" ref="context">
      <el-form class="form" :model="model" ref="base" label-position="left" label-width="100px" size="small">
        ...
        <el-form :inline="true" label-position="top">
          ...
          <!-- <el-form-item v-if="model.raffledType != 'guest' && (model.sourceType === 1 || model.sourceType === 2)" label="活动二维码" prop="qrCodeUrl" :rules="[{ required: false, message: '该字段不能为空'}]">
    ...
    showImgBox(state, imgName, index) {
      if (imgName) {
        ...
        if (imgName === 'item') {
          ...
          // else if (imgName === 'logoUrl') this.isCut = false
