      ...
      <div class="container">
        <div class="top_nav">
          <div class="query-table-box-button">
            <el-button type="primary" size="small" @click="openAddGroup">新建群发</el-button>
          </div>
        ...
        <div class="common-table-box" v-if="nowIndex == 0">
          ...
          >
            ...
            <el-table-column label="客户总数" prop="userQuantity" align="center"></el-table-column>
            <el-table-column label="送达客户" align="center">
              <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    openForm(row) {
      this.$openNewPage({path: `/main/scrm/groupsend/operation/group-details?id=${row.id}&type=copy`})
    },
    openDetali(row) {
    ...
    openAddGroup() {
      // this.$router.push('/main/scrm/groupsend/customersend/form')
      this.$router.push('/main/scrm/groupsend/operation/group-details')
    },
    relationClick(index) {
    ...
    openDraftForm(row) {
      this.$openNewPage({path: `/main/scrm/groupsend/operation/group-details?id=${row.id}&type=update`})
    },
