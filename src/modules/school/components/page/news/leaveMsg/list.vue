<template>
 <div class="wrap" ref="wrap">
    ...
    <qc-table-old ref="table" :height="domHeight" :table-list="showData" :search="searchData" url="api/admin/v1/comment/page">
    </qc-table-old>
...
export default {
  ...
  data() {
    return {
      ...
      showData: [
        { template: 'index' },
        { prop: "memberHeadImage", label: "头像", template: 'img', headImage: true, isPrefix: true },
