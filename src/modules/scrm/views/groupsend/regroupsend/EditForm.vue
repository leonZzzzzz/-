<template>
  <div class="newlyaddedDiv">
    <div class="header_nav">
      <el-button type="text" icon="el-icon-arrow-left" @click="$router.go(-1)">修改群发</el-button>
    </div>
        ...
        <div class="personal-send-form">
          <el-form label-width="120px">
            ...
            <el-form-item class="btn-primary-padding">
              <el-button @click="$router.go(-1)" plain>取消</el-button>
              <el-button @click="addBtn" type="primary">保存</el-button>
              <!-- <el-button @click="saveDrafts" type="info" :disabled="isDraftDisable">保存到草稿箱</el-button> -->
...
export default {
  ...
  methods: {
    ...
    addSave() {
      ...
      api.groupChatUpdate(this.models).then((res) => {
