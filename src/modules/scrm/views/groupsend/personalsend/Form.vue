          ...
          <el-form label-width="120px">
            ...
            <el-form-item label="选择客户:" :required="true">
              <div
                ...
                v-if="spanName.length == 0 && customerData.length == 0"
              >
              ...
              <div
                class="personal-send-userbox"
                @click="showSelectionCustomerList()"
                v-if="customerData.length != 0 && spanName.length == 0"
              >
                <i class="el-icon-user-solid icon-user"></i>
                <span>指定客户</span>
                <i class="el-icon-arrow-down icon-down"></i>
              ...
              <div v-if="customerData.length == 0 && spanName.length == 0" style="margin-top: 10px">
                <el-alert
              ...
              <div v-if="customerData.length != 0" class="customer-div-margin">
                <el-form-item>
                  <el-table
                    :header-cell-style="{
                      'text-align': 'center',
        ...
        <div class="personal-send-form">
          <el-form label-width="120px">
            <el-form-item label="群发消息1:">
              ...
              <div class="welcome-buttom">
                ...
                <div class="welcome-div">
                  ...
                  <el-button plain size="mini" @click="insert('<客户昵称>')">成员昵称</el-button>
                  ...
                  <span class="welcome-salename">成员昵称</span> -->
                </div>
              </div>
            </el-form-item>
            ...
            <el-form-item label="群发时间" :required="true">
              ...
              <div v-if="sendType == 'time' || changeIndex == true">
            ...
            <el-form-item class="btn-primary-padding">
              <el-button @click="saveDrafts" :disabled="isDraftDisable" plain>保存到草稿箱</el-button>
        ...
        <div class="query-table" style="display: flex; justify-content: flex-end">
          <div class="query-table-left">
            <div class="search-input">
              <el-input placeholder="输入客户名称" v-model="selectionSearchContent" clearable @input="selectionSearch">
              </el-input>
            </div>
            <div class="quert-table-title" @click="openTagList()">
              <span class="query-table-choose" v-if="spanName.length == 0">请选择客户标签</span>
              <template>
...
export default {
  components: { ComPagination, ComDialog, Emotion, SelectProgramItem },
  data() {
    return {
  ...
  methods: {
    ...
    changeTag(tagId, id, name, groupId) {
      ...
      newGroup = this.groupId.indexOf(id)
      if (arrIndex > -1) {
    ...
    sumbitTagDialog() {
      ...
      //     map.set(item.groupId, item.id)
      //   } else {
      //     map.set(item.id, map.get(item.groupId) + '_' + item.id)
      //   }
      // })
      this.stringNews = ''
      let groupIds = {}
    ...
    // getInputLength(val) {
    //   this.models.message.length = val.length
    // }
  },
  created() {
    this.getAllCustomer()
