<template>
  <div>
    <div class="title">
      自定义字段
      <el-button style="margin-left: 10px" plain size="mini" @click="createCustom">新建</el-button>
    </div>
    ...
    <Dialog :configure="configure" @closeDialog="closeDialog" @success="success">
      <el-form :model="ruleForm" label-position="left" ref="ruleForm" label-width="80px">
        ...
        <el-form-item label="输入类型" :required="true">
          <el-radio-group v-model="ruleForm.type" @change="setItemNumber">
        ...
        <div v-if="ruleForm.type == 'radio' || ruleForm.type == 'checkbox'">
          <el-form-item
            class="myFormItem"
    ...
    success() {
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          ...
          if ((this.ruleForm.type == 'radio' || this.ruleForm.type == 'checkbox') && this.ruleForm.optionName == '') {
            console.log('哈哈哈')
